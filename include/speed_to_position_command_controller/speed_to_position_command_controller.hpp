...
#include "speed_to_position_command_controller_parameters.hpp"
 ...
 */
class SpeedToPositionCommandController : public SpeedToPositionControllersBase
{
  public:
    SPEED_TO_POSITION_COMMAND_CONTROLLER_PUBLIC
    SpeedToPositionCommandController();
